...
\begin{figure}[htb]
    ...
    \label{image:dist_number_of_chars}
\end{figure}

\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{chapter_2/image/norvig_bigram_frequency.png}
    \caption[Biểu đồ tần suất 2 từ liền kề trong tiếng Anh (đơn vị phần nghìn \textperthousand)]{Biểu đồ tần suất 2 từ liền kề trong tiếng Anh\footnotemark (đơn vị phần nghìn \textperthousand)}
    \label{image:english_bigram_frequency}
\end{figure}
\footnotetext{https://norvig.com/mayzner.html}
