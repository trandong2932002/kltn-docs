...
\begin{figure}[htb]
    ...
    \caption{Biểu diễn đầu vào của BERT: Bao gồm các token embedding, token segment và token position.\cite{devlin2019bertpretrainingdeepbidirectional}}
...
\begin{figure}[htb]
    ...
    \caption{Minh họa việc tinh chỉnh BERT cho các tác vụ khác nhau \cite{devlin2019bertpretrainingdeepbidirectional}}
