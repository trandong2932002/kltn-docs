...
\begin{figure}[htb]
    ...
    \caption{Kiến trúc của mô hình Tranformer \cite{tranformer}}
    \label{figure:tranformer-architecture}
\end{figure}

Kiến trúc của Tranformer được minh hoạt ở hình \ref{figure:tranformer-architecture}, gồm 2 phần là Encoder bên trái và Decoder bên phải\cite{webpage23}.
