Quá trình huấn luyện được thực hiện với hai mô hình học sâu là LSTM và GRU. Bảng \ref{table:lstm-model} và Bảng \ref{table:gru-model} là tóm tắt của từng mô hình.
